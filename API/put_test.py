...
def test_put_resource_requests_successfully_changed_values(client, resource_request, cost, volume):
    data = {"volume": volume,
            "cost": cost}
...
def test_put_resource_requests_change_needed_at(client, resource_request):
    data = {
